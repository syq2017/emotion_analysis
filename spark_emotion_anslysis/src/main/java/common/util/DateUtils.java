...
public class DateUtils {
    ...
    public final static String FILE_PATTERN = "yyyy_MM_dd_HH_mm_ss";
    ...
    public static void main(String[] args) {
        ...
        String dateToString = DateUtils.dateToString(new Date(), LONG_PATTERN);
        System.out.println(dateToString);

        System.out.println(DateUtils.dateToString(new Date(), FILE_PATTERN));
